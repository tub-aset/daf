 ...
 * @generated
 */
public class DoorsDBModelPackageImpl extends EPackageImpl implements DoorsDBModelPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @see de.jpwinkler.daf.doorsdb.doorsdbmodel.DoorsDBModelPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private DoorsDBModelPackageImpl() {
        super(eNS_URI, DoorsDBModelFactory.eINSTANCE);
    }
    ...
    public static DoorsDBModelPackage init() {
        ...
        theDoorsDBModelPackage.createPackageContents();

        // Initialize created meta-data
        theDoorsDBModelPackage.initializePackageContents();
     ...
     */
    @Override
    public DoorsDBModelFactory getDoorsDBModelFactory() {
        return (DoorsDBModelFactory)getEFactoryInstance();
    }
