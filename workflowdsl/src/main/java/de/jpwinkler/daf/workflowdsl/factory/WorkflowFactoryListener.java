...
public class WorkflowFactoryListener extends WorkflowBaseListener {

    private final Deque<List<ModuleSetEntry>> moduleSetEntries = new LinkedList<>();
    private final Deque<List<OperationFeature>> operationFeatures = new LinkedList<>();
    private final Deque<List<Variable>> variables = new LinkedList<>();
