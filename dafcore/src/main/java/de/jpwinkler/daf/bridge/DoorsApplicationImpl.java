...
public class DoorsApplicationImpl implements DoorsApplication {
    ...
    public DoorsApplicationImpl(OutputStream outputStream) {
        this(null, null, null, null, outputStream);
    }

    public DoorsApplicationImpl(String doorsPath, String doorsServer, String user, String password) {
     ...
     */
    public DoorsApplicationImpl(String doorsPath, String doorsServer, String user, String password, OutputStream outputStream) {
        if (loadError != null) {
