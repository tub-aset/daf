 ...
 * </p>
 * <ul>
 *   <li>{@link de.jpwinkler.daf.doorscsv.model.dbimpl.LinkImpl#getSource <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	protected EClass eStaticClass() {
		return DoorsPackage.Literals.LINK;
	}
	...
	public DoorsObject getSource() {
		if (eContainerFeatureID() != DoorsPackage.LINK__SOURCE) return null;
	...
	public NotificationChain basicSetSource(DoorsObject newSource, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSource, DoorsPackage.LINK__SOURCE, msgs);
		return msgs;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DoorsPackage.LINK__SOURCE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
