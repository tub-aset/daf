...
public class DoorsAdapterFactory extends AdapterFactoryImpl {
	...
	protected DoorsSwitch<Adapter> modelSwitch =
		new DoorsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDoorsDatabase(DoorsDatabase object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.jpwinkler.daf.model.DoorsDatabase <em>Database</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.jpwinkler.daf.model.DoorsModuleVersion <em>Module Version</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
