...
public class DoorsCSVPackageImpl extends EPackageImpl implements DoorsCSVPackage {
	...
	public void createPackageContents() {
		...
		DoorsModuleVersionEClass = createEClass(DOORS_DATABASE_VERSION);
		createEReference(DoorsModuleVersionEClass, DOORS_DATABASE_VERSION__MODULE);
		createEAttribute(DoorsModuleVersionEClass, DOORS_DATABASE_VERSION__DATE);
		createEReference(DoorsModuleVersionEClass, DOORS_DATABASE_VERSION__ATTRIBUTES);
