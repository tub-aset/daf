 ...
 * @generated
 */
public class DoorsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DoorsPackage.DOORS_TREE_NODE: {
			...
			case DoorsPackage.DOORS_MODULE: {
			...
			case DoorsPackage.DOORS_OBJECT: {
			...
			case DoorsPackage.LINK: {
				Link link = (Link)theEObject;
				T result = caseLink(link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DoorsPackage.RESOLVED_LINK: {
			...
			case DoorsPackage.UNRESOLVED_LINK: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Module Version</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Module Version</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
