 ...
 * </p>
 * <ul>
 *   <li>{@link de.jpwinkler.daf.doorscsv.model.impl.DoorsDBImpl#getRoot <em>Root</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoorsDBImpl extends MinimalEObjectImpl.Container implements DoorsDB {
	...
	protected EClass eStaticClass() {
		return DoorsCSVPackage.Literals.DOORS_DB;
	}
	...
	public NotificationChain basicSetRoot(DoorsFolder newRoot, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DoorsCSVPackage.DOORS_DB__ROOT, oldRoot, newRoot);
	...
	public void setRoot(DoorsFolder newRoot) {
		if (newRoot != root) {
			...
			if (root != null)
				msgs = ((InternalEObject)root).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DoorsCSVPackage.DOORS_DB__ROOT, null, msgs);
			if (newRoot != null)
				msgs = ((InternalEObject)newRoot).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DoorsCSVPackage.DOORS_DB__ROOT, null, msgs);
			msgs = basicSetRoot(newRoot, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DoorsCSVPackage.DOORS_DB__ROOT, newRoot, newRoot));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DoorsCSVPackage.DOORS_DB__ROOT:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DoorsCSVPackage.DOORS_DB___ACCEPT__DOORSTREENODEVISITOR:
