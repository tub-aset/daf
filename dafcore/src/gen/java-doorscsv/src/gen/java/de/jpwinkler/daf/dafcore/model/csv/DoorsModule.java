 ...
 * </ul>
 *
 * @see de.jpwinkler.daf.dafcore.model.csv.DoorsCSVPackage#getDoorsModule()
 * @model
 * @generated
 */
public interface DoorsModule extends DoorsTreeNode {
	 ...
	 * @see #setName(String)
	 * @see de.jpwinkler.daf.dafcore.model.csv.DoorsCSVPackage#getDoorsModule_Name()
	 * @model
	 * @generated
	 */
	String getName();
	 ...
	 * @see #setPath(String)
	 * @see de.jpwinkler.daf.dafcore.model.csv.DoorsCSVPackage#getDoorsModule_Path()
	 * @model
	 * @generated
	 */
	String getPath();
	 ...
	 * @see #setUrl(String)
	 * @see de.jpwinkler.daf.dafcore.model.csv.DoorsCSVPackage#getDoorsModule_Url()
	 * @model
	 * @generated
	 */
	String getUrl();
	 ...
	 * @see de.jpwinkler.daf.dafcore.model.csv.DoorsCSVPackage#getDoorsModule_AttributeDefinitions()
	 ...
	 * @see #setView(String)
	 * @see de.jpwinkler.daf.dafcore.model.csv.DoorsCSVPackage#getDoorsModule_View()
	 * @model
	 * @generated
	 */
	String getView();
