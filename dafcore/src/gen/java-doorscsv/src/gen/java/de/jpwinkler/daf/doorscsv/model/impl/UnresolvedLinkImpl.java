 ...
 * </p>
 * <ul>
 *   <li>{@link de.jpwinkler.daf.doorscsv.model.impl.UnresolvedLinkImpl#getTargetModule <em>Target Module</em>}</li>
 *   <li>{@link de.jpwinkler.daf.doorscsv.model.impl.UnresolvedLinkImpl#getTargetObject <em>Target Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnresolvedLinkImpl extends LinkImpl implements UnresolvedLink {
	...
	protected EClass eStaticClass() {
		return DoorsCSVPackage.Literals.UNRESOLVED_LINK;
	}
	...
	public void setTargetModule(String newTargetModule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DoorsCSVPackage.UNRESOLVED_LINK__TARGET_MODULE, oldTargetModule, targetModule));
	}
	...
	public void setTargetObject(String newTargetObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DoorsCSVPackage.UNRESOLVED_LINK__TARGET_OBJECT, oldTargetObject, targetObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DoorsCSVPackage.UNRESOLVED_LINK__TARGET_MODULE:
				return getTargetModule();
			case DoorsCSVPackage.UNRESOLVED_LINK__TARGET_OBJECT:
