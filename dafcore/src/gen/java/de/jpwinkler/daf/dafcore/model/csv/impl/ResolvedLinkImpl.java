...
public class ResolvedLinkImpl extends LinkImpl implements ResolvedLink {
    ...
    protected EClass eStaticClass() {
        return CSVPackage.Literals.RESOLVED_LINK;
    }
        ...
        if (target != null && target.eIsProxy()) {
            ...
            if (target != oldTarget) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, CSVPackage.RESOLVED_LINK__TARGET, oldTarget, target));
            }
        }
        return target;
    }
    ...
    public NotificationChain basicSetTarget(DoorsObject newTarget, NotificationChain msgs) {
        ...
        target = newTarget;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CSVPackage.RESOLVED_LINK__TARGET, oldTarget, newTarget);
    ...
    public void setTarget(DoorsObject newTarget) {
        if (newTarget != target) {
            ...
            if (target != null)
                msgs = ((InternalEObject)target).eInverseRemove(this, CSVPackage.DOORS_OBJECT__INCOMING_LINKS, DoorsObject.class, msgs);
            if (newTarget != null)
                msgs = ((InternalEObject)newTarget).eInverseAdd(this, CSVPackage.DOORS_OBJECT__INCOMING_LINKS, DoorsObject.class, msgs);
            msgs = basicSetTarget(newTarget, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CSVPackage.RESOLVED_LINK__TARGET, newTarget, newTarget));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case CSVPackage.RESOLVED_LINK__TARGET:
                if (target != null)
                    msgs = ((InternalEObject)target).eInverseRemove(this, CSVPackage.DOORS_OBJECT__INCOMING_LINKS, DoorsObject.class, msgs);
