 ...
 * </p>
 * <ul>
 *   <li>{@link de.jpwinkler.daf.doorsdb.model.impl.DBModuleImpl#getVersions <em>Versions</em>}</li>
 *   <li>{@link de.jpwinkler.daf.doorsdb.model.impl.DBModuleImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link de.jpwinkler.daf.doorsdb.model.impl.DBModuleImpl#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DBModuleImpl extends DBItemImpl implements DBModule {
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case DoorsDBPackage.DB_MODULE__TAGS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DoorsDBPackage.DB_MODULE__VERSIONS:
				return getVersions();
			case DoorsDBPackage.DB_MODULE__URL:
				return getUrl();
			case DoorsDBPackage.DB_MODULE__TAGS:
				return getTags();
		}
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case DoorsDBPackage.DB_MODULE___HAS_TAG__STRING:
