 ...
 * </p>
 * <ul>
 *   <li>{@link de.jpwinkler.daf.doorsdb.model.impl.DBTagImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.jpwinkler.daf.doorsdb.model.impl.DBTagImpl#getModules <em>Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DBTagImpl extends MinimalEObjectImpl.Container implements DBTag {
    ...
    protected EClass eStaticClass() {
		return DoorsDBPackage.Literals.DB_TAG;
	}
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DoorsDBPackage.DB_TAG__NAME, oldName, name));
	}
    ...
    public EList<DBModule> getModules() {
		if (modules == null) {
			modules = new EObjectWithInverseResolvingEList.ManyInverse<DBModule>(DBModule.class, this, DoorsDBPackage.DB_TAG__MODULES, DoorsDBPackage.DB_MODULE__TAGS);
		}
		return modules;
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DoorsDBPackage.DB_TAG__MODULES:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DoorsDBPackage.DB_TAG__NAME:
				return getName();
			case DoorsDBPackage.DB_TAG__MODULES:
				return getModules();
		}
