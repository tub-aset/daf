...
public class CodeBeamerModelConstructor extends RuleBasedModelConstructor {
    ...
    private void addMetric(final CodeBeamerModel model, final String metricName, final double metricValue) {
        final DoubleMetric metric = CodebeamerFactory.eINSTANCE.createDoubleMetric();
