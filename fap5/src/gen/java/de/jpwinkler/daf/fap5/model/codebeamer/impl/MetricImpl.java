...
public abstract class MetricImpl extends MinimalEObjectImpl.Container implements Metric {
    ...
    protected EClass eStaticClass() {
        return CodebeamerPackage.Literals.METRIC;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CodebeamerPackage.METRIC__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case CodebeamerPackage.METRIC__NAME:
                return getName();
        }
